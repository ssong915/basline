...
def train(args):
    ...
    os.makedirs(f'/home/dake/workspace/HNHN,HGNN/data/{args.dataset_name}/{args.eval_mode}/{args.model}', exist_ok=True)
    args.model_save = f'/home/dake/workspace/HNHN,HGNN/data/{args.dataset_name}/{args.eval_mode}/{args.model}'
    ...
    for i in range(args.exp_num): # number of splits (default: 5)
        ...
        if args.eval_mode == 'train_fixed_split' :
            auc_roc, ap = train_fixed_split.train(args, st_model, full_data, full_time, decoder, optimizer, scheduler, f_log, i)
        else :
